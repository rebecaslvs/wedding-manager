        ...
        <div class="pix-content">
          ...
          <div class="pix-dados-container">
            ...
            <div class="pix-botoes">
              <a
                href="https://wa.me/5577988289651"
                target="_blank"
                class="btn btn-primary"
                @click="handlePixWhatsappClick"
              >WhatsApp Rebeca</a>
              <a
                href="https://wa.me/5577988097836"
                target="_blank"
                class="btn btn-primary"
                @click="handlePixWhatsappClick"
              >WhatsApp Marcos</a>
    ...
    <div v-if="showLinksModal" class="modal-overlay" @click="closeLinksModal">
      <div class="modal" @click.stop>
        ...
        <div class="links-content">
          <p style="text-align: justify;">O pagamento via link é feito diretamente pelo WhatsApp. Por favor, clique em um dos contatos abaixo e lhe enviaremos o link para finalizar a compra do presente.</p>
          <div class="pix-botoes">
              <a
                href="https://wa.me/5577988289651"
                target="_blank"
...
// Função para finalizar compra ao clicar no WhatsApp do Pix ou Link
function handlePixWhatsappClick() {
  // Sempre salva como pendente, independente do método
  savePayment();
  ...
  store.cart.forEach(item => {
    ...
    if (gift) {
      store.addPurchase({
        ...
        status: (checkoutData.value.paymentMethod === 'pix' || checkoutData.value.paymentMethod === 'link') ? 'pending' : 'completed'
      })
    }
  })
  store.clearCart()
