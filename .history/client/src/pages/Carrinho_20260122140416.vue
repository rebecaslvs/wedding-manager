        ...
        <div class="pix-content">
          ...
          <div class="pix-dados-container">
            ...
            <div class="pix-botoes">
              <a href="https://wa.me/5577988289651" target="_blank" class="btn btn-primary">WhatsApp Rebeca</a>
              <!-- <button @click="closePixModal" class="btn btn-outline">Cancelar</button> -->
              <a href="https://wa.me/5577988097836" target="_blank" class="btn btn-primary">Enviar comprovante no
                WhatsApp</a>
              <!-- <button @click="closePixModal" class="btn btn-outline">Cancelar</button> -->
            </div>
          </div>
