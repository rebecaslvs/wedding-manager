        ...
        <div v-else class="gifts-grid">
          <div v-for="gift in filteredGifts" :key="gift.id" class="gift-card">
            ...
            <div class="gift-actions">
              ...
              <button @click="openEditGift(gift)" class="btn btn-outline" style="margin-top:8px;">Editar</button>
            </div>
          </div>
        </div>
        <button @click="openEditGift(null)" class="btn btn-primary" style="margin-bottom:2rem;">Adicionar Presente</button>

        <div v-if="showGiftModal" class="modal-overlay">
          <div class="modal">
            <h2>{{ editingGift && editingGift.id ? 'Editar Presente' : 'Adicionar Presente' }}</h2>
            <form @submit.prevent="saveGift">
              ...
              <div class="form-group">
                ...
                <textarea v-model="giftForm.description" />
              </div>
              <div class="form-group">
                <label>Valor (R$)</label>
              ...
              <div class="form-group">
                ...
                <div v-if="giftForm.image" style="margin-top:8px;">
                  <img :src="giftForm.image" alt="Prévia da imagem" style="max-width:120px;max-height:120px;" />
                </div>
              </div>
