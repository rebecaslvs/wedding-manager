    ...
    <div class="container">
      ...
      <div class="content">
        <div class="filters">
          <div class="search-box">
            <input v-model="searchQuery" type="text" placeholder="Buscar presentes..." class="search-input" />
          </div>
          ...
          <div v-for="gift in filteredGifts" :key="gift.id" class="gift-card">
            ...
            <div class="gift-actions">
              <div class="quantity-selector">
                ...
                <input v-model.number="quantities[gift.id]" type="number" min="0" class="qty-input" />
                <button @click="incrementQuantity(gift.id)" class="qty-btn">+</button>
              </div>
              <button @click="addToCart(gift.id)" :disabled="quantities[gift.id] === 0" class="btn btn-primary">
                Adicionar ao Carrinho
              </button>
              <button v-if="auth.isAdminLoggedIn" @click="openEditGift(gift)" class="btn btn-outline"
                style="margin-top:8px;">Editar</button>
            </div>
          </div>
        </div>
        <button v-if="auth.isAdminLoggedIn" @click="openEditGift(null)" class="btn btn-primary"
          style="margin-bottom:2rem;">Adicionar Presente</button>
      ...
      <div class="cart-summary">
        <div class="summary-card">
          ...
          <router-link to="/carrinho" class="btn btn-primary">
            Ver Carrinho
          </router-link>
        </div>
      </div>
