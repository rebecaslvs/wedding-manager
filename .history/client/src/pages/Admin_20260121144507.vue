// Função para editar convidado (exemplo: abrir modal ou preencher formulário)
const editGuest = (guest: any) => {
  // Aqui você pode implementar a lógica de edição, como abrir um modal ou preencher o formulário de edição
  alert(`Função de editar convidado chamada para: ${guest.name}`)
}
<template>
  <div class="admin">
...
// O modal deve estar dentro do bloco <template>, não no script
