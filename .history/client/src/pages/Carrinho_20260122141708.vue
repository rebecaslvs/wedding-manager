    ...
    <div v-if="showLinksModal" class="modal-overlay" @click="closeLinksModal">
      <div class="modal" @click.stop>
        ...
        <div class="links-content">
          <p>O pagamento via link é feito diretamente pelo WhatsApp. Por favor, clique em um dos contatos abaixo e lhe enviaremos o link para finalizar o envio do presente.</p>
