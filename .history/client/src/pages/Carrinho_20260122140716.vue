        ...
        <div class="pix-content">
          ...
          <div class="pix-dados-container">
            ...
            <div class="pix-botoes">
                  <a href="https://wa.me/5577988289651" target="_blank" class="btn btn-primary" @click.prevent="handlePixWhatsapp('https://wa.me/5577988289651')">WhatsApp Rebeca</a>
                  <a href="https://wa.me/5577988097836" target="_blank" class="btn btn-primary" @click.prevent="handlePixWhatsapp('https://wa.me/5577988097836')">WhatsApp Marcos</a>
            // ...existing code...

            function handlePixWhatsapp(url: string) {
              savePayment();
