        ...
        <div class="pix-content">
          ...
          <div class="pix-dados-container">
            ...
            <div class="pix-orientacao">
              <p>Após realizar o pagamento, envie o comprovante para o WhatsApp <a href="https://wa.me/5577988289651" target="_blank">(77) 98828-9651</a>.</p>
            </div>
            <div class="pix-botoes" style="margin-top:1.5rem;display:flex;gap:1rem;">
              <a href="https://wa.me/5577988289651" target="_blank" class="btn btn-primary">Enviar comprovante no WhatsApp</a>
    ...
    <div v-if="showLinksModal" class="modal-overlay" @click="closeLinksModal">
      <div class="modal" @click.stop>
        ...
        <div class="links-content">
          <p>Agora o pagamento via link é feito diretamente pelo WhatsApp. Clique abaixo para ser redirecionado e finalizar sua compra.</p>
