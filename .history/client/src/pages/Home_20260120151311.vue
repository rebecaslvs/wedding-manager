...
.ceremony {
  padding: 4rem 2rem;
  background: linear-gradient(180deg, #f9f9f9 0%, var(--primary-light) 100%);
}
...
.guide-romantic {
  ...
  background: linear-gradient(135deg, var(--primary-light) 0%, #e6d6f7 100%);
  position: relative;
  overflow: hidden;
}
...
.cta {
  padding: 4rem 2rem;
  background: linear-gradient(135deg, #e6d6f7 0%, var(--primary-dark) 100%);
