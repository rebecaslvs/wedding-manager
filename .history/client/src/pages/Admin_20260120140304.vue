          ...
          <table>
            ...
            <tbody>
              <tr v-for="purchase in store.purchases" :key="purchase.id">
                ...
                <td>{{ purchase.paymentMethod === 'pix' ? 'Pix' : purchase.paymentMethod === 'link' ? 'Link' : 'Loja' }}</td>
                <td>
                  <a v-if="purchase.paymentLink" :href="purchase.paymentLink" target="_blank" class="link-badge">Ver Link</a>
