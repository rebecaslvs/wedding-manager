<template>
  <div class="home">
    ...
    <section class="hero">
      ...
      <!-- Degradê floral romântico -->
      <div class="hero-floral">
        <svg viewBox="0 0 320 80" fill="none" xmlns="http://www.w3.org/2000/svg">
          <ellipse cx="60" cy="70" rx="40" ry="10" fill="#b39ddb"/>
          <ellipse cx="160" cy="75" rx="60" ry="12" fill="#e6d6f7"/>
          <ellipse cx="260" cy="70" rx="40" ry="10" fill="#b39ddb"/>
          <ellipse cx="110" cy="60" rx="18" ry="5" fill="#b868b5"/>
          <ellipse cx="210" cy="60" rx="18" ry="5" fill="#b868b5"/>
        </svg>
      </div>
    </section>
...
.hero-floral {
  ...
  height: 80px;
  margin-top: -40px;
  background: linear-gradient(180deg, rgba(255,255,255,0) 0%, var(--primary-light) 80%, var(--accent) 100%);
  display: flex;
...
.romantic-info li {
  ...
  line-height: 1.8;
  font-size: 1.13rem;
  /* Removido flex para evitar quebra de texto */
}
.romantic-bullet {
  font-size: 1.15rem;
  margin-right: 0.4em;
...
.cta {
  ...
  box-shadow: 0 -8px 32px 0 rgba(179,157,219,0.10);
}
