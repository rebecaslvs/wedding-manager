      ...
      <div class="container">
        ...
        <div class="guide-content">
          <div class="guide-item">
            <h3>1. Confirme sua Presença</h3>
            <p>Clique no botão "Confirmar Presença" para nos informar se você poderá comparecer ao nosso casamento.</p>
          </div>
          <div class="guide-item">
            <h3>2. Escolha um Presente</h3>
            <p>Visite nossa lista de presentes e escolha aquele que deseja presentear-nos.</p>
          </div>
          <div class="guide-item">
            <h3>3. Finalize a Compra</h3>
            <p>Você pode pagar via Pix ou informar que comprará em uma loja e entregará pessoalmente.</p>
          </div>
        </div>
      </div>
    </section>
...
.guest-info-box {
  background: linear-gradient(135deg, #fff7e6 0%, #f5e6ff 100%);
