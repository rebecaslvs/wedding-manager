            ...
            <div v-if="showAccompaniantsForm" class="accompanists-form">
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  placeholder="0"
                  @input="accompanists.adults = Math.min(accompanists.adults, currentGuest.adultsCount)"
                />
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  placeholder="0"
                  @input="accompanists.children = Math.min(accompanists.children, currentGuest.childrenCount)"
                />
...
const submitConfirmation = () => {
  if (currentGuest.value) {
    ...
    // Atualiza o objeto reativamente buscando o convidado atualizado
    const updated = store.getGuestByName(currentGuest.value.name)
    if (updated) {
