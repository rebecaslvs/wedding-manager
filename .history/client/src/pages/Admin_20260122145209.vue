          ...
          <form @submit.prevent="addNewGuest" class="form">
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <input v-model.number="newGuest.childrenCount" type="number" id="newGuestChildrenCount" min="0"
                  required />
              </div>
            </div>
            ...
            <table>
              ...
              <tbody>
                <tr v-for="guest in store.guests" :key="guest.id" :class="['guest-row', guest.status]">
                  ...
                  <td style="gap: 8px; display: flex; align-items: center;">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <div v-if="newGift.image" class="image-preview" style="margin-top:8px;">
                  <img :src="newGift.image" alt="Prévia da imagem"
            ...
            <table>
              ...
              <tbody>
                <tr v-for="gift in store.gifts" :key="gift.id">
                  ...
                  <td>
                    <img v-if="gift.image" :src="gift.image" alt="Imagem do presente"
            ...
            <tbody>
              <tr v-for="purchase in store.purchases" :key="purchase.id">
                ...
                <td style="display:flex;gap:0.5rem;align-items:center;">
                  ...
                  <button v-if="purchase.status === 'pending'" @click="markPurchaseCompleted(purchase.id)"
                    class="btn-edit" style="background:#4caf50;">Concluir</button>
                  <button v-else @click="markPurchasePending(purchase.id)" class="btn-edit"
                    style="background:#ffc107;color:#333;">Aguardar</button>
                </td>
              </tr>
            </tbody>
          </table>
...
onMounted(() => {
  ...
  weddingForm.value = { ...store.weddingInfo, pixKey: store.weddingInfo.pixKey ?? '' }
  watchEffect(() => {
...
.guests-table td[style*="display: flex"] {
  align-items: center;
  height: 100%;
}
