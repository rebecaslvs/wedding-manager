    ...
    <div v-if="showLinksModal" class="modal-overlay" @click="closeLinksModal">
      <div class="modal" @click.stop>
        ...
        <div class="links-content">
          <p>O pagamento via link é feito diretamente pelo WhatsApp. Por favor, clique em um dos contatos abaixo e lhe enviaremos o link para finalizar a compra do presente.</p>
          <div class="pix-botoes">
              <a
                href="https://wa.me/5577988289651"
                target="_blank"
